...
<?php require_once ("header.php") ?>
  <div class='container'> 
    <div class='row'>
      ...
      <div class='span3'>
        <a href='commande.php' class='btn btn-default pull-right'>
          <i class='icon-plus'></i>
          Retourner
        </a>
      </div>
    ...
    <?php
        ...
        $req=mysql_query("SELECT datecom,libprd,qteliv,prixcom,montant_paye from ligne_client c,commande_client d,produit p where c.idcom=d.idcom and c.refprod=p.refprod");
        if ($req) {
